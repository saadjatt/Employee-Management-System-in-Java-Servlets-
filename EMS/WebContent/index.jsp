                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="widget green-1 animated fadeInDown">
                            <div class="widget-content padding">
								...
								empcount = emp.countAllEmployees();
								deptcount = dept.countAllDepartments();
								
								%>
                                
                                    <p class="maindata">TOTAL <b>Employees</b></p>
                                    
                                    <h2><span class="animate-number" data-value="<%=empcount %>" data-duration="3000">0</span></h2>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="widget darkblue-2 animated fadeInDown">
                            <div class="widget-content padding">
                                ...
                                <div class="text-box">
                                    <p class="maindata">TOTAL <b>DEPARTMENTS</b></p>
                                    <h2><span class="animate-number" data-value="<%=deptcount %>" data-duration="3000">0</span></h2>
                        ...
                        <div class="widget orange-4 animated fadeInDown">
                            <div class="widget-content padding">
                                ...
                                <div class="text-box">
                                    ...
                                    <h2><span class="animate-number" data-value="<%=(empcount+1)%>" data-duration="3000">0</span></h2>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            <div class="widget-footer">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="widget lightblue-1 animated fadeInDown">
                            <div class="widget-content padding">
                                ...
                                <div class="text-box">
                                    <p class="maindata">OVERALL <b>DATA</b></p>
                                    <h2><span class="animate-number" data-value="<%= (empcount+deptcount)%>" data-duration="3000">0</span></h2>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                            <div class="widget-footer">
