			...
			<div>
				<div class="row">
					...
					<h4>Department name</h4>
						<form role="form" method="<%=method %>"  action="DepartmentServlet"  >
						  					
						  <div class="form-group">
							<input type="text" name="dname" class="form-control" placeholder="Enter department" value="<%= dname %>">
						  </div>
            ...
            <div class="content">
            	...
            	<div class="widget">
					<div class="widget-header transparent">
						<h2><strong>Department</strong> Crud</h2>
					...
					<div class="widget-content padding">
						<form class="form-inline" role="form">
						  ...
						  <a class="btn btn-primary md-trigger" style="width:100%" data-modal="form-modal"  ><%= action %> Department</a>
						</form>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget">
							<div class="widget-header">
								<h2><strong>Department</strong> Data Sheet</h2>
								<div class="additional-btn">
									<a href="#" class="hidden reload"><i class="icon-ccw-1"></i></a>
									<a href="#" class="widget-toggle"><i class="icon-down-open-2"></i></a>
									<a href="#" class="widget-close"><i class="icon-cancel-3"></i></a>
									...
									<table id="datatables-1" class="table table-striped table-bordered" cellspacing="0" width="100%">
									        ...
									        <tbody>
									            	...
									            	%>
									                	...
									                	<tr>
									                	<td> <%= db.getDeptName() %></td>
									                	
									               	   	<td><a href="department.jsp?editid=<%=db.getDeptId()%>"><span class="label label-success">Edit</span></a></td>  				
									               	   	<td><a href="department.jsp?delid=<%=db.getDeptId()%>"><span class="label label-danger">Delete</span></a></td>
									                	</tr>
